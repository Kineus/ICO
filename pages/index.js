...
export default function Home() {
  ...
  const [tokenMinted, setTokensMinted] = useState[zero];
  ...
  return (
    <div>
      ...
      <div className={style.main}>
        <div>
          <h1 className={style.title}> Welcome to Crypto Devs ICO</h1>
          <div className={style.description}>
            Yoy can claim or mint Crypto Dev tokens here
          </div>
          {walletConnected ? (
            <div>
              <div className={styles.description}>
